...
class ProductThread(threading.Thread):
    ...
    def run(self):
        ...
        while not getValue('PRODUCT_EXIT'):
            be = time.time()
            sql = f"select id,source_id,aminer_id,profilePubsTotal,lw_path from {self.table_name}  where id >%s  and  is_ava=1 and is_zl =0 order by id asc"
...
class ConsumerThread(threading.Thread):
    ...
    def run(self):
        ...
        while not consumer_thread_exit:
            ...
            in_id = row[0]
            source_id = row[1]          #id,source_id,aminer_id,profilePubsTotal,lw_path
            aminer_id=row[2]
            ...
            if profilePubsTotal == 0:
                ...
                while 1:
                    ...
                    if res.status_code == 200:
                        ...
                        print(path)  #Y:/cg_expert_data/html/aminer_zl_1000/1/142/
                        ...
                        update_sql = f"update {self.table_name}  set zl_path=%s,is_zl=%s where id = %s"
